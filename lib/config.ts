export const config = {
    ...
    bibleVerse: process.env.NEXT_PUBLIC_QURAN_VERSE || "Default Bible Verse",
    bibleVerseContent: process.env.NEXT_PUBLIC_QURAN_VERSE_CONTENT || "Default Bible Verse Content",
    ...
    holyMatrimony: {
        ...
        place_details: process.env.NEXT_PUBLIC_LOCATION_PLACE_DETAILS || "Default Street",
        googleMapsLink: process.env.NEXT_PUBLIC_LOCATION_GOOGLE_MAPS || "https://maps.app.goo.gl/vPmfWux29qYYfkJTA",
    },
    weddingReception: {
